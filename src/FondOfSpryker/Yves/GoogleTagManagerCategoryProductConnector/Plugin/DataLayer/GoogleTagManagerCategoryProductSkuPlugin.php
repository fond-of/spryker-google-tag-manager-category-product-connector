 ...
 */
class GoogleTagManagerCategoryProductSkuPlugin extends AbstractPlugin implements GoogleTagManagerDataLayerExpanderPluginInterface
{
    ...
    public function expand(string $page, array $twigVariableBag, array $variableList): array
    {
        return $this->getFactory()
            ...
            ->getProductSku($page, $twigVariableBag, $variableList);
    }
}
