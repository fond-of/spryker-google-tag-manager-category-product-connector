 ...
 */
class GoogleTagManagerCategoryProductIdAbstractPlugin extends AbstractPlugin implements GoogleTagManagerDataLayerExpanderPluginInterface
{
    ...
    public function expand(string $page, array $twigVariableBag, array $variableList): array
    {
        return $this->getFactory()
            ...
            ->getIdProductAbstract($page, $twigVariableBag, $variableList);
    }
