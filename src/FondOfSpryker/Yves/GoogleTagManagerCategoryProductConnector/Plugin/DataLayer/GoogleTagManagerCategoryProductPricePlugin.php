 ...
 */
class GoogleTagManagerCategoryProductPricePlugin extends AbstractPlugin implements GoogleTagManagerDataLayerExpanderPluginInterface
{
    ...
    public function expand(string $page, array $twigVariableBag, array $variableList): array
    {
        return $this->getFactory()
            ...
            ->getProductPrice($page, $twigVariableBag, $variableList);
    }
}
